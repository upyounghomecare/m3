...
function styleCorrLine(){try{var items=[].slice.call(document.querySelectorAll('.cart-item'));items.forEach(function(it){var h=it.querySelector('.detail h4')||it.querySelector('h4')||it.querySelector('.item-name');if(!h)return;if((h.textContent||'').indexOf('方案折扣校正')>=0){h.textContent='加購品優惠價・不參與方案折扣';h.style.cssText='color:#0C447C;font-weight:700;font-size:13px';var hide='position:absolute!important;width:1px!important;height:1px!important;overflow:hidden!important;opacity:0!important;pointer-events:none';var q=it.querySelector('.quantity');if(q)q.style.cssText=hide;var tool=it.querySelector('.item-tool');if(tool)tool.style.cssText=hide;var qty=Number(it.getAttribute('data-qty'))||0;var meta=it.querySelector('.meta');if(meta)meta.innerHTML='<span style="color:#0C447C;font-weight:700">＋ NT$ '+qty.toLocaleString()+'</span>';}});}catch(e){}}
