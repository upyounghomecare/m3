...
+'.qw{position:relative;background:#fff;border-radius:18px;width:100%;max-width:640px;max-height:92vh;overflow-y:auto;padding:20px 18px 18px;box-shadow:0 14px 44px rgba(0,0,0,.35)}'
...
+'.qw .wel-h{font-size:clamp(17px,5.7vw,24px);font-weight:900;color:#16202b;margin:0 0 10px;line-height:1.42;white-space:normal;text-wrap:balance;-webkit-text-stroke:0.4px #16202b}'/* 修:原本nowrap+固定24px,窄螢幕標題會被切掉27px。改成字級隨螢幕縮放且允許換行,任何寬度都不會被切 */
...
+'#qw-toast{position:fixed;left:0;right:0;bottom:24px;z-index:100001;text-align:center;pointer-events:none}#qw-toast span{background:#042C53;color:#fff;font-size:13px;padding:10px 18px;border-radius:999px;font-family:inherit}'/* ===== 內文CSS 舊 .qw 區塊搬遷(2026-08-06)=====
